...
BOT_TOKEN = environ.get('BOT_TOKEN', "6799203558:AAEhnRvxlIf_BnMkwo0IOkb0nTkxa0EZK00")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002133531200')).split()]
...
URL = "https://jkdev-7ed0f006d43d.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jkdev-7ed0f006d43d.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jkdev-7ed0f006d43d.herokuapp.com/".format(FQDN)
else:
    URL = "https://jkdev-7ed0f006d43d.herokuapp.com/".format(FQDN)
